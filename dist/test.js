//正则表达式 验证
var phone = '215072422893';
// 1  3-9的任意一位数字  9个数字  匹配一部分条件
...
console.log(result2);
//^ (非)的使用
console.log(/[^123]/.test('246'));
console.log(/[^2]/.test('2'));
//条件分组 不能打空格
console.log(/ab|cd/.test('ab'));
//邮箱验证
var email = '947452831@qq.com';
...
var keyword = '小公鸡';
var tempMenus = menus.filter(function (menu) {
    //菜单的名字一定包含关键字，或者惨淡的食材关键字搜索
    return menu.name.indexOf(keyword) != -1 || menu.matrial.some(function (food) {
        return food.indexOf(keyword) != -1;
    });
});
